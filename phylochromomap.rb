...
def get_parameters
	...
	return path2files , treesFolder , chromoSizeFile , mappingFile , majorClade , minorsXmajor
	
end

def main		
	
	path2files , treesFolder , chromoSizeFile , mappingFile , majorClade , minorsXmajor = get_parameters

	result_counts = TreesCriteria_counts2.count(path2files, treesFolder, majorClade, mappingFile)
	puts result_counts
end
